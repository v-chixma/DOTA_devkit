...
class splitbase():
    def __init__(self,
        ...
        #self.labelpath = r'/home/yxzh/dataset/icpr2018/train/labelTxt/labelTxt'
    ...
    def SplitSingle(self, name, rate, extent):
        ...
        assert weight < 100000, 'weight >= 100000'
        assert height < 100000, 'height >= 100000'
        ...
        while (left < weight):
            ...
            while (up < height):
                ...
                subimgname = outbasename + '%05d' %left + '_' + '%05d' %up
...
if __name__ == '__main__':
    ...
    basepath = r'/home/yxzh/dataset/icpr2018/val'
    outpath = r'/home/yxzh/mount_31/cxma/dataset/odai/val_split_cxma'
    if not os.path.isdir(outpath):
        os.makedirs(outpath)
    if not os.path.isdir(os.path.join(outpath,'images')):
        os.makedirs(os.path.join(outpath,'images'))
    if not os.path.isdir(os.path.join(outpath,'labelTxt')):
        os.makedirs(os.path.join(outpath,'labelTxt'))
