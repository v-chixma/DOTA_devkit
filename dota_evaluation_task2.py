...
def parse_gt(filename):
    ...
    with open(filename, 'r') as f:
        ...
        for splitline in splitlines:
            ...
            x1 = min(map(int,(map(float,(splitline[0:8:2])))))
            x2 = max(map(int,(map(float,(splitline[0:8:2])))))
            y1 = min(map(int,(map(float,(splitline[1:8:2])))))
            y2 = max(map(int,(map(float,(splitline[1:8:2])))))
            object_struct['bbox'] = [x1,y1,x2,y2]
            #print x1,y1,x2,y2
            #pdb.set_trace()
...
def main(detpath,annopath,imagesetfile):
    ...
    #detpath = r'/home/yxzh/mount_31/cxma/software/detectron/tmp/odai_val_results_an16_hbbox_merged/Task2_{:s}.txt'
    #annopath = r'/home/yxzh/dataset/icpr2018/val/labelTxt/{:s}.txt'# change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
...
if __name__ == '__main__':
    ...
    annopath = r'PATH_TO_BE_CONFIGURED/{:s}.txt'# change the directory to the path of val/labelTxt,
    imagesetfile = r'PATH_TO_BE_CONFIGURED/val.txt'
    main(detpath,annopath,imagesetfile)